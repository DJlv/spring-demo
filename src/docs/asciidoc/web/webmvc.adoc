...
----
	...
	@ControllerAdvice("org.springframework.controllers")
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<bean id="conversionService"
			...
			<property name="converters">
				<set>
					<bean class="org.springframework.MyConverter"/>
				</set>
			</property>
			<property name="formatters">
				<set>
					<bean class="org.springframework.MyFormatter"/>
					<bean class="org.springframework.MyAnnotationFormatterFactory"/>
				</set>
			</property>
			<property name="formatterRegistrars">
				<set>
					<bean class="org.springframework.MyFormatterRegistrar"/>
				</set>
			</property>
		</bean>
...
----
	<mvc:interceptors>
		...
		<mvc:interceptor>
			...
			<bean class="org.springframework.SecurityInterceptor"/>
		</mvc:interceptor>
	</mvc:interceptors>
----
...
----
	...
	<bean id="pathHelper" class="org.springframework.app.MyPathHelper"/>
	<bean id="pathMatcher" class="org.springframework.app.MyPathMatcher"/>
----
