...
annotation (that is, `@ComponentScan("org.springframework")`).
...
| annotation (default)
| `org.springframework.SomeAnnotation`
...
| custom
| `org.springframework.MyTypeFilter`
...
----
	@Configuration
	@ComponentScan(basePackages = "org.springframework", nameGenerator = MyNameGenerator.class)
	public class AppConfig {
		// ...
	}
----
...
----
	<beans>
		<context:component-scan base-package="org.springframework"
			name-generator="org.springframework.MyNameGenerator" />
	</beans>
----
...
----
	@Configuration
	@ComponentScan(basePackages = "org.springframework", scopeResolver = MyScopeResolver.class)
	public class AppConfig {
		// ...
	}
----
...
----
	<beans>
		<context:component-scan base-package="org.springframework" scope-resolver="org.springframework.MyScopeResolver"/>
	</beans>
----
...
----
	@Configuration
	@ComponentScan(basePackages = "org.springframework", scopedProxy = ScopedProxyMode.INTERFACES)
	public class AppConfig {
		// ...
	}
----
...
----
	<beans>
		<context:component-scan base-package="org.springframework" scoped-proxy="interfaces"/>
	</beans>
----
